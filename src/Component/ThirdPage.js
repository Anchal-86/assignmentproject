  ...
  return (
    <div>
      <div style={{display:"flex",justifyContent:"center",alignItems:"center",height:"80vh"}}>
        <div>
          <img style={{width:"400px",height:"350px"}} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSkawqSk0dy4w9pP49TJfNt4WAqGb2UXX047k_zYEMSLOMcZQlEmV5QOS-qoEuRg_k3Q2U&usqp=CAU" alt="" />
        </div>
